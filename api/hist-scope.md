...
{
  "id": "f2",
  "path": "tx/2026-05-14/a3f1c2/change-1",
  "value": {
    "title": "selectors",
    "value": "...",
...
{
  "id": "f3",
  "path": "tx/2026-05-14/a3f1c2/change-2",
  "value": {},
  "map_bindings": {
    "content": "hist/change",
    "op": "link",
...
- структурные поля `target.node.id`, `target.link.name`,
  `target.link.from.id`, `target.link.to.id`;
  ...
  "ops": [
    {
      "select": {
        "selector": {
          ...
          "target.link.from.id": "2a",
          "target.link.to.id": "11"
        },
  ...
  "ops": [
    {
      "select": {
        "selector": {
          ...
          "value.rollback_of.tx_id": "a3f1c2"
        },
        "include": ["value", "map_bindings"]
      }
    }
...
Селектор по `value.rollback_of.tx_id` поддерживается hist-схемой
