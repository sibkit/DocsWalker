...
Реализация DocsWalker ведётся по стратегии в [.planning/stg-0001.docswalker/](.planning/stg-0001.docswalker/). Управление — через скилл `/planning`. При возобновлении сессии: прочитать `strategy.md`, реализовывать шаги в порядке списка сверху вниз.
