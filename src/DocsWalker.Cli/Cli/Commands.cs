...
internal static class Commands
{
    ...
    private static List<CommandSpec> Build()
    {
        return new List<CommandSpec>
        {
            ...
            Read("get_subtree",
                desc: "Полное поддерево узла в указанном tree-scope (по умолчанию path).",
                examples: new[] { "docswalker get-subtree --id=0", "docswalker get-subtree --id=PROJECT --tree=strategic" },
